...
/* Extra keys */
#define KEY_BRIGHTNESSUP 0x16F
#define KEY_BRIGHTNESSDOWN 0x170
#define KEY_AIRPLANE 0x2C6
#define KEY_FN 0xFFFF
...
// Using for special function #define KEY_MEDIA_REFRESH 0xfa
// Using for special function #define KEY_MEDIA_CALC 0xfb
